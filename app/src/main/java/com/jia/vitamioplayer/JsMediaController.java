...
/**
 * Describtion:自定义视频控制器
 * Created by jia on 2017/8/16.
 * 人之所以能，是相信能
 */
public class JsMediaController extends MediaController {
    ...
    public JsMediaController(Context context, VideoView videoView, Activity activity) {
        super(context);
